...
function WishlistScreen() {
  ...
  return (
    <SafeScreen>
      {/* HEADER */}
      <View className='mt-5 px-6 pb-5 border-b border-surface flex-row items-center'>
        <TouchableOpacity
         onPress={() => router.back()}
         className='mr-4'
        >
        ...
        <Text className='text-text-primary text-2xl font-bold flex-1 ml-2'>Wishlist</Text>
      ...
      </View>
      {
        wishlist.length === 0 ? (
          <View className='flex-1 items-center justify-center px-6'>
            ...
            <TouchableOpacity
             className='bg-primary rounded-2xl px-8 py-6 mt-6'
             activeOpacity={0.8}
                ...
                >
                  <View className='flex-row p-4'>
                    <Image 
                     ...
                     className='rounded-2xl bg-background-light'
