                ...
                <View className='flex-1 ml-4 justify-between'>
                  ...
                  <View className='flex-row items-center mt-3'>
                    <TouchableOpacity
                     ...
                     activeOpacity={0.7}
                     onPress={() => {setProId(item.product._id); handleQuantityChange(item.product._id, item.quantity, -1)}}
                     disabled={isUpdating}
                    >
                      {isUpdating && proId === item.product._id ? (
                    ...
                    <View className='mx-4 min-w-[32px] items-center ml-4 mr-4'>
