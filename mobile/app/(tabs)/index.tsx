    ...
    <SafeScreen>
      ...
      >
        ...
        <View className='px-5 pb-4 pt-6'>
          ...
          {/* SEARCH BAR */}
          <View className='bg-surface flex-row items-center px-5 py-1 rounded-3xl'>
        ...
        <View className='px-6 mb-6'>
          <View className='flex-row items-center justify-between mb-4'>
            ...
            <Text className='text-text-secondary text-sm'>{filtereProducts.length} items</Text>
          </View>

          {/* PRODUCTS GRID */}
          <ProductsGrid  products={filtereProducts} isLoading={isLoading} isError={isError}/>
