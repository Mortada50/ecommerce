...
export async function createProduct(req, res) {
  try {
    ...
    console.log("Error createing a products: ", error);
...
export async function getAllProducts(_, res) {
  try {
    ...
    console.log("Error gitting all products: ", error);
    res.status(500).json({ message: "Internal server error" });
  }
}
...
export async function getAllOrders(_, res) {
  try {
    const orders = await Oreder.find()
...
export async function updateOrderStatus(req, res) {
  try {
    ...
    const order = await Oreder.findById(orderId);
...
export async function getAllCustomers(_, res) {
  try {
    ...
    if (!customers) return res.status(404).json({ message: "No users found" });
